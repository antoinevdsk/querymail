  	...
  	<p><a href="/mail" class="btn btn-success"><span class="fa fa-plus"></span> Create a new mail</a></p>
		...
		<?php foreach ($oMails as $oMail):?>
			<tr>
				...
				<td>
					<a href="/mail/index/<?=$oMail->MAIL_ID;?>" class="btn btn-xs btn-primary" title="Modify"><span class="fa fa-edit"></span></a>
					<a href="/mail/send/<?=$oMail->MAIL_ID;?>" class="btn btn-xs btn-primary sendMail"><span class="fa fa-send"></span></a>
					<a href="/mail/delete/<?=$oMail->MAIL_ID;?>" class="btn btn-xs btn-danger confirm" title="Delete"><span class="fa fa-trash"></span></a>
				</td>
			</tr>
		<?php endforeach;?>
		</table>
