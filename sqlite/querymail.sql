...
INSERT INTO QMAIL_KPI VALUES (1,1,'Data comparison','Compare KPI between two days','SELECT DATE, SUM(NB_SEARCH) NB_SEARCH, SUM(NB_DISPLAY) NB_DISPLAY, SUM(NB_CLICK) NB_CLICK, ROUND((SUM(NB_CLICK) / SUM(NB_DISPLAY)) *100, 2) CTR\r\nFROM QMAIL_EXAMPLE\r\nWHERE DATE = "2016-11-01"','SELECT DATE, SUM(NB_SEARCH) NB_SEARCH, SUM(NB_DISPLAY) NB_DISPLAY, SUM(NB_CLICK) NB_CLICK, ROUND((SUM(NB_CLICK) / SUM(NB_DISPLAY)) *100, 2) CTR\r\nFROM QMAIL_EXAMPLE\r\nWHERE DATE = "2016-11-02"','querymail','',1,'2016-10-18 12:20:14',1,'GRAPH_HTML','BAR',1,0,'',NULL,0,0,1,''),(2,1,'Group query','Select data and group them by a specific column (GEOZONE_CODE in this example)','SELECT GEOZONE_CODE, SUM(NB_SEARCH) NB_SEARCH, SUM(NB_DISPLAY) NB_DISPLAY, SUM(NB_CLICK) NB_CLICK, ROUND((SUM(NB_CLICK) / SUM(NB_DISPLAY)) *100, 2) CTR\r\nFROM QMAIL_EXAMPLE\r\nGROUP BY GEOZONE_CODE','','querymail','GEOZONE_CODE',1,'2016-10-18 09:56:52',1,'HTML','BAR',1,0,'',NULL,0,0,1,'0');
